...
export const CONVENIOS: Convenio[] = [
  ...
  },
  {
    ...
    beneficiarios: 'Vecinos de Las Condes (con beneficio ampliado para personas de 60 años o más)',
    descuento: 'hasta 20%',
    detalle: [
      'Vecinos en general — 15% dcto.: Tina $310.250 · Hidromasaje $391.000, e incluye barra de seguridad de 40 cm de acero inox con instalación gratis',
      'Personas mayores (60 años o más) — 20% dcto.: Tina $292.000 · Hidromasaje $368.000',
      'Instalación de accesorios complementarios — 10% dcto. (solo si se contrata únicamente la instalación)',
      'Cambio de WC — 10% dcto. en el servicio (no incluye el artefacto)',
      'No acumulable con otras promociones',
    ],
    zona: 'RM',
    vigencia: 'hasta el 31/12/2026',
  ...
  },
  {
    ...
    beneficiarios: 'Vecinos de Providencia con Tarjeta Vecino',
    descuento: '20%',
    detalle: [
      'Tina tradicional: $292.000 (normal $365.000) — ahorras $73.000',
      'Hidromasaje: $368.000 (normal $460.000) — ahorras $92.000',
      'Incluye barra de seguridad de 40 cm de acero inox + instalación gratis',
      'Precios finales con IVA · no acumulable con otras promociones',
    ],
    zona: 'RM',
    vigencia: 'hasta el 31/12/2026',
  },
  {
    ...
    beneficiarios: 'Vecinos de La Reina',
    descuento: '20%',
    detalle: [
      'Tina tradicional: $292.000 (normal $365.000)',
      'Hidromasaje: $368.000 (normal $460.000)',
